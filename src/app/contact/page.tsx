...
export default function ContactPage() {
  return (
    <section className="flex min-h-[70vh] items-center justify-center bg-brand-background section-padding">
      <div className="container-main text-center">
        <SectionHeading
          title="Ready to Scale?"
          subtitle="Message us directly on WhatsApp to get started."
        />
